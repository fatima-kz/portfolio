...
const Experience = () => {  const experiences = [
    ...
    },
    {
      ...
      description: "Built automation workflows using n8n, integrating tools like Gemini, Airtable, Make, and Google Workspace. Designed scalable AI-driven automations, connecting LLMs with external APIs, databases, and custom business workflows.",
      type: "work",
      skills: ["n8n", "Gemini", "Airtable", "Make", "LLM Integration"],
      techIcons: [FaCode, FaLaptopCode],
      color: "pastel-pink",
    ...
    },
    {
      ...
      company: "Minas Code — Forge Internship Program",
      location: "Islamabad, Pakistan",
      period: "June 2024 - Aug 2024",
      description: "Co-founded a simulated start-up and built an MVP end-to-end, winning both the pitch and demo. Gained practical experience in full-stack development, entrepreneurship, and team collaboration.",
      type: "work",
      skills: ["MERN", "Next.js", "LiveKit", "ShadCN", "Zustand", "JWT Auth"],
